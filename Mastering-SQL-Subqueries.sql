...
SELECT a.Customer_Name, a.Age, a.Region, a.Customer_ID, b.Category FROM
(SELECT * FROM CUSTOMERS 
WHERE Region = 'South') a,
(SELECT * FROM Sales) b
WHERE a.Customer_ID = b.Customer_ID;
------
SELECT a.Customer_Name, a.Age, a.Region, a.Customer_ID, b.Category
FROM Customers a
INNER JOIN Sales b
...
SELECT first_name, last_name, (SELECT AVG(salary) from salaries) from employees; 
...
(SELECT Customer_name FROM customers c WHERE c.Customer_ID = s.Customer_ID) FROM sales s
...
SELECT a.emp_no, a.first_name, a.last_name, b.dept_no FROM employees a JOIN
(SELECT * FROM dept_emp 
WHERE dept_no IN 
(SELECT dept_no FROM departments 
